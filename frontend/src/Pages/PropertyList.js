...
import GridPropertyList from "../Components/GridPropertyList";
  ...
  return (
    <>
      <div className={`bg-white`}>
        <Header />
        <div className="container mx-auto flex h-full flex-col items-center pt-28 pb-10 justify-center content-center">
          ...
          <Box sx={{ width: "80%", marginTop: "50px", marginBottom: "50px" }}>
            ...
            >
              ...
              <Grid item xs={12} md={4}>
                <Button className="p-2  font-bold  w-full" variant="outlined" style={{fontSize:"20px"}} onClick={handleReset}>
                  Show All Properties
                </Button>
              </Grid>
            </Grid>
      ...
      <GridPropertyList  OnRent={OnRent} Floor={floors} Bedrooms={bedrooms} Phase={phase} />
      <Footer />
    </>
  );
};
